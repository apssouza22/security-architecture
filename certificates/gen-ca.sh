...
## The root certificate is not signed by any other certificate, and it is the first certificate in the chain of trust.
...
openssl genrsa -out gen/protected/intermediateCA.key 4096
openssl req -new -config ca_config.cnf -key gen/protected/intermediateCA.key -out gen/protected/intermediateCA.csr
openssl x509 -req -in gen/protected/intermediateCA.csr -CA gen/protected/rootCA.pem -CAkey gen/protected/rootCA.key -CAcreateserial -out gen/protected/intermediateCA.pem -days 3650 -sha256  -extfile ca_config.cnf -extensions v3_ca
